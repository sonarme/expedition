package com.sonar.expedition.scrawler.util;
     ...
     */
    public class TermVectorClassifier {
        public static String[] DOCS = {
                "The quick red fox jumped over the lazy brown dogs.",
                "Mary had a little lamb whose fleece was white as snow.",
                "Moby Dick is a story of a whale and a man obsessed.",
                "The robber wore a black flece jacket and a baseball cap.",
        ...
        public static void main(String[] args) throws IOException {
            ...
            SpanTermQuery fleeceQ = new SpanTermQuery(new Term("content", "brown dogs"));
            //MultiPhraseQuery mpq = new MultiPhraseQuery();
            //mpq.add(new Term("content", "brown dogs"));
