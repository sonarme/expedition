...
public final class BidRequestExt implements Externalizable, Message<BidRequestExt> {
    ...
    public String getIdfatracking() {
        return idfatracking;
    }

    public void setIdfatracking(String idfatracking) {
    ...
    static final Schema<BidRequestExt> SCHEMA = new Schema<BidRequestExt>() {
            ...
            for (int number = input.readFieldNumber(this); ; number = input.readFieldNumber(this)) {
                switch (number) {
                    ...
                    case 13:
                        ...
                        break;
                    case 14:
                        message.idfatracking = input.readString();
                        break;
                    default:
        ...
        public void writeTo(Output output, BidRequestExt message) throws IOException {
            ...
            if (message.idfatracking != null)
                output.writeString(14, message.idfatracking, false);
        }
